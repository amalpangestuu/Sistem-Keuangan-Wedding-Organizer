...
if (isset($_POST['simpan'])) {
    mysqli_query($koneksi, "INSERT INTO kas_keluar VALUES(
        NULL,
        '$_POST[tanggal]',
        '$_POST[event]',
        '$_POST[keterangan]',
...
<?php
$data = mysqli_query($koneksi, "SELECT * FROM kas_keluar ORDER BY tanggal DESC");
...
<tr>
    ...
    <td>
        <a class="btn-edit" href="kas_keluar_edit.php?id=<?= $d['id'] ?>">Edit</a>
        <a class="btn-hapus" 
           href="kas_keluar_hapus.php?id=<?= $d['id'] ?>"
